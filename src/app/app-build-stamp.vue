...
<template>
  ...
  >
    <div class="flex items-center gap-3">
      <span
        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-linear-to-br from-slate-700 to-slate-900 text-xs font-bold tracking-wide text-white shadow-md"
        aria-hidden="true"
      >
        PWA
      </span>
